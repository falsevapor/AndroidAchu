...
class CouponFragment : Fragment() {
    ...
    private var mListener: OnCouponInteractionListener? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            ...
            view.adapter = MyCouponRecyclerViewAdapter(CouponsContent.ITEMS, mListener)
        }
        return view
    }
    ...
    override fun onAttach(context: Context?) {
        ...
        if (context is OnCouponInteractionListener) {
            mListener = context
        } else {
    ...
    companion object {
        ...
        fun newInstance(columnCount: Int): CouponFragment {
